...
public class Controller {
	...
	//Generator is a Singletonton class responsible for generating fake investors and companies
	...
	public Controller() {
		...
		//The start() method receives the fake investors and companies as parameters and sends back how many trades were made
		int numbOfTrades = tradeSimulation.start(generator.investors(),  generator.companies());
		menu.clean(); //Print a few empity lines
		System.out.println("Simulation completed, " + numbOfTrades + " trades were executed!"); //Just a message with the number of trades
		getMenuOption();//Show Menu and ask for input
	}
	
	/**
	 * THis method displays the menu and ask for an input
	 * It uses a switch and facade pattern to generate the results asked by the user
	 */
