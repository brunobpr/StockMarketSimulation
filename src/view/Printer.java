...
public class Printer {
	...
	/**
	 * @param investors
	 *            the list of investors (worst/best) to be displayed
	 * @param message
	 *            a message of 'best' or 'worst'
	 */
	...
	/**
	 * @param companies
	 *            the list of companies (best/worst) to be displayed
	 * @param message
	 *            a message of 'best' or 'worst'
	 */
	...
	/**
	 * @param value
	 *            a double value with trillions of decimals digits ... not good to
	 *            be displayed
	 * @return a string representing the double value with two decimal digits ...
	 *         good to be displayed
	 */
