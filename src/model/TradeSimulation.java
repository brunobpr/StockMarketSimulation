...
public class TradeSimulation {
	 ...
	 * @param investors list of 100 fake investors
	 * @param companies list of 100 fake companies
	...
	/** 
	 * @param investor the investors trying to buy the share
	 * @param company the company that may own the share
	 */
		...
		if (company.getNumOfShares() > 0) {
			...
			if (investor.geBudgte() > company.getSharePrice()) {
				...
				if (investor.geBudgte() * 0.15 > company.getSharePrice()) {
					...
					//Show them a company with more affordable shares, 
	...
	/**
	 * @param investor The investor trying to save some money.
	 * @param badPrice The price of the share he/she can't buy
	 */
	...
	/**
	 * @param investor The investor who is ready to buy the share
	 * @param company The company ready to sell the share
	 */
	...
	/**
	 * @param investor The investor who needs to be investisgated by the CAA (Could't Afford Association)
	...
	private boolean budgetChecker(Investor investor) {
		for (int i = 0; i < listOfCompany.size(); i++) {
			//Go through the the list of companies and check if the investor still has money
