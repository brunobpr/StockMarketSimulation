...
public enum TradeObserver implements Observer {
	...
	// So there was no way to add the companies with add(company1), add(company2),
	// add(company3) and so on...
	// The solution I found was to create a singleton observer that is going to be
	// used by all 100 comapanies.
	// When a new company is created it gets the instance of the observer and adds
	// itself to the list of companies being watched
	instance;
	...
	/*
	 * This method is used by the company class to remove any compony that sold all
	 * the shares
	 * 
	...
	/*
	 * This method iterates through all the companies of the list to see if the
	 * companies have sold any share
	 * 
