...
public class ResultSorter {
	...
	//All the method on this class has the only porpuse of sorting the lists according to what the users wants
	//The methos receives an unsorted list and sends back a sorted one, without changing the real list
	
	// Investor with the highest number of shares
	// If there is more than one investor in any of the positions, they all should be displayed in the result.
	/**
	 * @param investors the list unsorted investors, it won't be modified
	...
	/**
	 * @param companies unsorted list of companies, it wont be modified
