...
public class Company {
	...
	/**The value of the variable capital is the equivalent of the initial number of shares of the company
	...
	//This method will be called only if the trade met all the conditions created as part of the simulation
	public void sell() {
		// The company MUST notifty the observer if any share is sold
		// The reason for that is the obeserver must be aware of how many shares are sold among all companies
		observer.update();
		...
		//If the company has 0 shares available, it must be removed from the observer list
		if(numOfShares == 0) {
	...
	//Company Builder was implemented to facilate the creation of 100 fake companies
